...
pub fn solarize(image_path: &str, image_output_directory: &str, parse_filename: &str) -> Result<(), Box<dyn std::error::Error>> {
...
pub fn colorize(image_path: &str, image_output_directory: &str, parse_filename: &str) -> Result<(), Box<dyn std::error::Error>> {
  let mut img = photon::native::open_image(image_path)?;
...
pub fn halftone(image_path: &str, image_output_directory: &str, parse_filename: &str) -> Result<(), Box<dyn std::error::Error>> {
  let mut img = photon::native::open_image(image_path)?;
...
pub fn horizontal_strips(image_path: &str, image_output_directory: &str, parse_filename: &str, num_strips: u8) -> Result<(), Box<dyn std::error::Error>> {
  let mut img = photon::native::open_image(image_path)?;
...
pub fn primary(image_path: &str, image_output_directory: &str, parse_filename: &str) -> Result<(), Box<dyn std::error::Error>> {
  let mut img = photon::native::open_image(image_path)?;
